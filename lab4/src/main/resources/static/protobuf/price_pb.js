export function encodePriceUpdate(message) {
  let bb = popByteBuffer();
  _encodePriceUpdate(message, bb);
  return toUint8Array(bb);
}

function _encodePriceUpdate(message, bb) {
...
export function decodePriceUpdate(binary) {
  return _decodePriceUpdate(wrapByteBuffer(binary));
}

function _decodePriceUpdate(bb) {
  let message = {};
